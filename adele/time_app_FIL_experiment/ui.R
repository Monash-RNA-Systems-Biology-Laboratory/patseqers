  ...
  sidebarLayout(
    ...
    mainPanel (
      tabsetPanel(type = "tabs",
                  tabPanel("Plot", 
                           plotOutput("time_plot", width = "1200px", height = "600px", click = "plot_click"),
              ...
              at each time point. The varistran package was used to normalised the raw counts")
                  ...
                  tabPanel("Table of data plotted",
                           ...
                           helpText("Time points between 2 and 3 have been modified in order to be plotted neatly on the x-axis.")
                  ),
